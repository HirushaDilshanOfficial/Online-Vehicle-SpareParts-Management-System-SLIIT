...
@WebServlet("/partsDeleteServlet")
public class partsDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isTrue;
		isTrue = hPartsController.deletedata(id);
		...
		List<partsModel> sparepartsdetails = hPartsController.getById(id);
