...
public class hUserController {
	...
	public static boolean insertdata(String name, String email, String phonenumber, String password) {
	    ...
	    try {
	        ...
	        // SQL query
	        String sql = "INSERT INTO user (name, email, phonenumber, password) VALUES('" + name + "', '" + email + "', '" + phonenumber + "', '" + password + "')";
	...
	public static List<sparepartsModel> getById (String Id) {
	    ...
	    ArrayList<sparepartsModel> users = new ArrayList<>();
...
//GetAll Data
public static List<sparepartsModel> getAlluser (){
	...
	public static boolean updateData(String id , String name , String email, String phonenumber ){//, String password) {
	    ...
	    try {
	        ...
	        // Correct SQL query
	        String sql = "UPDATE user SET name='" + name + "', email='" + email + "', phonenumber='" + phonenumber + "'"//, password='" + password + "' "
	        		+ "WHERE id='"+id+"'";                    
