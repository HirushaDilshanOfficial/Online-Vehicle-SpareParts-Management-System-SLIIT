...
<head>
    ...
    .customer-feedback .section-title h2 {
        font-size: 2.5rem;
        color: var(--primary-color);
        margin-bottom: 15px;
    }

    .customer-feedback .section-title p {
        color: #6c757d;
        max-width: 700px;
        margin: 0 auto;
    }
...
<body>
                ...
                <div class="auth-buttons">
                    <div class="login-dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="login.jsp"><i class="fas fa-user"></i> User Login</a>
                            <a href="SupplierLogin.jsp"><i class="fas fa-truck"></i> Supplier Login</a>
                            <a href="ManagerLogin.jsp"><i class="fas fa-tasks"></i> Manager Login</a>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            ...
            <a href="itemDisplay.jsp" class="btn">Shop Now <i class="fas fa-arrow-right"></i></a>
        </div>
    </section>
    ...
    <section class="customer-feedback" id="feedback">
    <div class="container">
        <div class="section-title">
        ...
        <div class="feedback-cards">
            <div class="feedback-card">
                <div class="feedback-avatar">
                    <img src="Assets/cus3.jpg" alt="Customer Avatar">
                </div>
                <div class="feedback-info">
                    <h3>John Doe</h3>
                    <p>"Great service, and the parts were delivered on time. I highly recommend Motor Bay!"</p>
                    <div class="rating">
            ...
            <div class="feedback-card">
                <div class="feedback-avatar">
                    <img src="Assets/cus2.jpg" alt="Customer Avatar">
                </div>
                <div class="feedback-info">
                    <h3>Jane Smith</h3>
                    <p>"Excellent quality parts. I’ve been using them for months without any issues!"</p>
                    <div class="rating">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="feedback-card">
                <div class="feedback-avatar">
                    <img src="Assets/cus1.jpg" alt="Customer Avatar">
                </div>
                <div class="feedback-info">
                    <h3>Michael Lee</h3>
                    <p>"The best online platform for vehicle parts. Fast and easy to use!"</p>
                    <div class="rating">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
    ...
    <footer id="contact">
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    ...
                    <div class="social-links">
                        <a href="https://www.facebook.com/share/12JzPB5LJSp/"><i class="fab fa-facebook-f"></i></a>
                        <a href="#"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.instagram.com/sliit.life?igsh=NWZhdTlmNnMydGQ2"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/school/sliit/"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="footer-column">
                    <h3>Quick Links</h3>
                    <ul class="footer-links">
                        <li><a href="#home">Home</a></li>
                        <li><a href="terms.jsp">Terms AND Condition</a></li>
                        <li><a href="#services">Services</a></li>
                ...
                <div class="footer-column">
                    <h3>Contact Us</h3>
                    <p><i class="fas fa-map-marker-alt"></i> NEW KANDY ROAD ,MALABE</p>
                    <p><i class="fas fa-phone"></i> +94 11 754 4801</p>
            ...
            <div class="copyright">
                <p>&copy; 2025 Motor Bay. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
