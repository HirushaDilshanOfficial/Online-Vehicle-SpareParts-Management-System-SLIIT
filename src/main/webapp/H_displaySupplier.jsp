        ...
        <div class="main-content">
            ...
            <div class="content-area">
                <div class="header">
                    ...
                    <button onclick="window.location.href='H_CreareSupplier.jsp'" class="create-btn">
                                ...
                                <tr class="table-row">
                                    ...
                                    <td class="table-cell">
                                        <div class="btn-container">
                                            ...
                                            <form action="supplierDeleteServlet" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this Supplier?');">
