...
<head>
    ...
    <title>Parts Mange section</title>
            ...
            <div class="bg-white shadow-md px-6 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        <img src="Asset/Screenshot 2025-04-22 at 10.26.03.png" alt="Admin Profile"
                            class="w-10 h-10 rounded-full border-2 border-[#097396] object-cover">
