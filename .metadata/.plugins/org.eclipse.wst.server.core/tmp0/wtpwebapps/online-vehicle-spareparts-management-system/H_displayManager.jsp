...
<head>
    ...
    <title>Manager Manage Section</title>
    ...
    <div class="flex-container">
        ...
        <div class="main-content">
            ...
            <div class="content-area">
                <div class="header">
                    <h2 class="title">Manager Records</h2>
                    <button onclick="window.location.href='H_CreateManager.jsp'" class="create-btn">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach var="manager" items="${allmanagers}">
                                <tr class="table-row">
                                    <td class="table-cell">${manager.id}</td>
                                    <td class="table-cell">${manager.name}</td>
                                    <td class="table-cell">${manager.email}</td>
                                    <td class="table-cell">${manager.phonenumber}</td>
                                    <td class="table-cell">
                                        <div class="btn-container">
                                            <a href="H_EditManager.jsp?id=${manager.id}&name=${manager.name}&email=${manager.email}&phonenumber=${manager.phonenumber}&password=${manager.password}" class="edit-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="managerDeleteServlet" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this manager?');">
